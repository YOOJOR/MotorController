...
def main() -> None:
    ...
    while running:
        ...
        if key != -1:
                    ...
                    # 1. 触发动作 
                    # 直接使用 low16 匹配，避免高位截断导致与字母 ASCII 码冲突
                    if low16 == 0xFF52 or low16 == ord("w") or low16 == ord("W"): # 上
                        target_tx_x, target_tx_y = 0, 1
                    elif low16 == 0xFF54 or low16 == ord("s") or low16 == ord("S"): # 下
                        target_tx_x, target_tx_y = 0, -1
                    elif low16 == 0xFF51 or low16 == ord("a") or low16 == ord("A"): # 左
                        target_tx_x, target_tx_y = -1, 0
                    elif low16 == 0xFF53 or low16 == ord("d") or low16 == ord("D"): # 右
                        target_tx_x, target_tx_y = 1, 0
                        
                    # 2. 归位动作 (主键盘的 0 或 小键盘的 0)
                    elif low16 == ord("0") or low16 == 0xFFB0 or low16 == 96:
