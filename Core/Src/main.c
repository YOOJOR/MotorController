...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, MOTOR_EN2_Pin|MOTOR_DIR2_Pin|MOTOR_EN1_Pin|MOTOR_DIR1_Pin
                          |LASER_Pin|D3LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : MOTOR_EN2_Pin MOTOR_DIR2_Pin MOTOR_EN1_Pin MOTOR_DIR1_Pin
                           LASER_Pin D3LED_Pin */
  GPIO_InitStruct.Pin = MOTOR_EN2_Pin|MOTOR_DIR2_Pin|MOTOR_EN1_Pin|MOTOR_DIR1_Pin
                          |LASER_Pin|D3LED_Pin;
...
/* USER CODE BEGIN 4 */
void UartParser_OnFrameReceived(void) { HAL_GPIO_WritePin(D3LED_GPIO_Port, D3LED_Pin, GPIO_PIN_SET); }

void HAL_UART_RxCpltCallback(UART_HandleTypeDef* huart) { UartParser_OnRxCpltCallback(huart); }

void HAL_UART_ErrorCallback(UART_HandleTypeDef* huart) { UartParser_OnErrorCallback(huart); }
